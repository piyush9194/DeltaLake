...
object Collections extends App{
   ...
   //  Collection methods like filter, foreach, map,
   //  reduceLeft, and many more have loops built into their algorithms.
   ...
   //    indexed se‐ quences and linear sequences (linked lists)
  ...
  /****************************************************
    ...
    You want to choose a Scala collection class
  ...
  • Do you want a mutable or immutable collection?
    ...
    ****************************************************/
    ...
    10.3. Choosing a Collection Method to Solve a Problem
      ...
      new output col‐ lection, typically using an algorithm you provide.
      They include ::::::::
...
/****************************************************
  ...
  Summary
  When you first start working with Scala, the behavior of a mutable variable with an immutable collection can be surprising. To be clear about variables:
...
******************************************************/
  ...
  /******************************************************
        ...
        Use ListBuffer if you prefer a linear sequential collection
        that is mutable
