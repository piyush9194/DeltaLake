...
object Collections extends App{
  ...
  ************************************************************************************************/
  ...
  /*********************************************************************************************************
    ...
    Eventually your brain will skip over the intermediate steps.
  *********************************************************************************************************/
  ...
  /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    val xa = Array(1,2,3,4,5,6,7,8,9)
    println("Hello")
    println(xa.drop(3).toList.toString())

    val peeps = List("John", "Mary", "Jane", "Fred")
    println(peeps.slice(1,3))

    /*********************************************************************************************************
      10.19. Splitting Sequences into Subsets (groupBy, partition, etc.)

      You want to partition a sequence into two or more different sequences (subsets)
      based on an algorithm or location you define.
      Use the groupBy, partition, span, or splitAt
    *******************************************************************************************************/
